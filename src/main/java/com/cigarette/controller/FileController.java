...
public class FileController {
    ...
    @GetMapping("/download")
    public String fileDownLoad(HttpServletResponse response, @RequestParam("file_name") String fileName) throws BusinessException, IOException {
    ...
    //@PostMapping("/upload")
    //@ResponseBody
    //public ApiRestResponse fileUpLoad(@RequestParam MultipartFile file) throws BusinessException, IOException {
    //    // 获取时间戳
