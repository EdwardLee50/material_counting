...
public class EncrypDes {
     ...
     * 字符串默认键值
     */
    private static final String STR_DEFAULT_KEY = Constant.APP_SECRET_KEY;
     ...
     * 默认构造方法，使用默认密钥
     */
    public EncrypDes() throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
    ...
    public EncrypDes(String strKey) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
